...
public abstract class BaseDwellingManagerTest {
	...
	public void createMansions() {
		...
		mansions.add(new Mansion(45.2, 52000, new Location(49.838883, 24.027453)));
		mansions.add(new Mansion(18.5, 46000, new Location(49.825672, 23.954481)));
		mansions.add(new Mansion(108.3, 51000, new Location(49.846594, 24.025002)));
		mansions.add(new Mansion(100, 55000, new Location(49.765081, 23.842558)));
	}
	...
	public void fillDwellingManager(DwellingManager dwellingManager) {
		...
		comparableListOfDwellings.add(new Mansion(45.2, 52000, new Location(49.838883, 24.027453)));
		comparableListOfDwellings.add(new Mansion(18.5, 46000, new Location(49.825672, 23.954481)));
		comparableListOfDwellings.add(new Mansion(108.3, 51000, new Location(49.846594, 24.025002)));
		comparableListOfDwellings.add(new Mansion(100, 55000, new Location(49.765081, 23.842558)));
